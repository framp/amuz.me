        ...
        _resizeMenu: function() {
            ...
            setTimeout(function() {
                ...
                var maxHeight = ul.css('max-height') || 0,
                    ...
                    height = $(window)
                        .height() - that.options.outHeight - ul.offset()
                        .top;
            ...
            function changeNgModel(data) {
                if (isObject(ngModel)) {
                    if (!ctrl.$viewValue && ctrl.$viewValue !== 0) {
                        ...
                        data.item.label = isObject(data.item.label) ? $('<div>')
                            .append(data.item.label)
